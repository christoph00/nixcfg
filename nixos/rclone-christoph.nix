{
  ...
  systemd.services.mount-christoph-nas = {
    ...
    serviceConfig = {
      ...
      ExecStart = "${pkgs.rclone}/bin/rclone mount --config ${config.age.secrets.rclone-conf.path} --vfs-cache-mode full --allow-other --vfs-cache-max-size 100M --no-modtime --gid 100 --uid 1000 --umask 022 CNAS: /home/christoph/NAS";

...
let cfg = config.internal.graphical.apps.firefox;
      ...
      policies = {
        ...
        ExtensionSettings = let
          ...
          extensions = {
            ...
            "de-DE@dictionaries.addons.mozilla.org".install_url =
              mozillaAddon "dictionary-german";
        ...
        SearchEngines = {
          Add = [
...

            {
              Name = "nix code";
              URLTemplate =
                "https://github.com/search?q={searchTerms}+lang%3Anix&type=code";
              Method = "GET";
              Alias = "nix";
              IconURL =
                "file://${pkgs.nixos-icons}/share/icons/hicolor/scalable/apps/nix-snowflake.svg";
